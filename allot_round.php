...
/*! \var $stud_obj for creating student class object. */
		...
		/*! \var $stud_obj for creating institute class object. */
...
///fetching student choice fillings
                    ...
                    for($i=0;$i<count($choice_result);$i++)
                    {
                        ...
                        if($inst_obj->isVacant($choice_result[$i]))
                        {
                            ...
                            $stud_obj->setNULL_second_round($roll);
                            break;
                        }
        ...
        $sql = "update allotment_date set allotment_held=true where round_number=2";
            $res = mysqli_query($conn,$sql);
			/// Displaying the first round allotment result.
        echo " <script> alert('Second Round Allotment completed!!!!');
